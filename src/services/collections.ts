...
/**
 * Récupère les artistes regroupés par type
 * @param lang - Langue des résultats
 * @returns Un objet avec les artistes regroupés par type
 */
export async function getArtistsGroupedByType(
  lang: string = "en"
